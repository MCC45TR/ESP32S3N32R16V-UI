...
| `MUS1` | Encrypted UART hedefi, iki taraf eşleşene kadar kapalı |

İlk bring-up kuralı: UART crypto kapalı kalsın; TX/RX/GND düşük riskle kanıtlanmadan flow control veya binary bridge açılmasın.
